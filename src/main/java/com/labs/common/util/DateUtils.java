...
public class DateUtils {
     ...
     *
     * @see DateUtils#convertDateStrToChineseDateStr(String, boolean)
     * @deprecated 方法已过期，替代方法为convertDateStrToChineseDateStr()
     */
    @Deprecated
     ...
     * @see DateUtils#getCurrentDateStr()
     */
    @Deprecated
     ...
     * @param date
     * @return Calendar
     * @see DateUtils#convertDateObjectToCalendar(java.util.Date)
     */
    @Deprecated
    ...
    public static Date dateString2Date(String dateStr, String partner) {
        try {
            ...
            java.util.Date current = formatter.parse(dateStr, pos);
            return current;
     ...
     * @return int 年份
     */
    public static int getYearOfDate(java.util.Date pDate) {
     ...
     * @return int 月份
     */
    public static int getMonthOfDate(java.util.Date pDate) {
        java.util.Calendar c = java.util.Calendar.getInstance();
        c.setTime(pDate);
     ...
     * @return int 日份
     */
    public static int getDayOfDate(java.util.Date pDate) {
        java.util.Calendar c = java.util.Calendar.getInstance();
        c.setTime(pDate);
     ...
     * @return int 分钟
     */
    public static int getMinuteOfDate(java.util.Date pDate) {
        java.util.Calendar c = java.util.Calendar.getInstance();
        c.setTime(pDate);
     ...
     * @return int 秒钟
     */
    public static int getSecondOfDate(java.util.Date pDate) {
        java.util.Calendar c = java.util.Calendar.getInstance();
        c.setTime(pDate);
     ...
     * @return long 毫秒
     */
    public static long getMillisOfDate(java.util.Date pDate) {
        java.util.Calendar c = java.util.Calendar.getInstance();
        c.setTime(pDate);
     ...
     *
     * @param pUtilDate Date
     * @param pFormat   String 格式1:"yyyy-MM-dd" 格式2:"yyyy-MM-dd hh:mm:ss EE"
    ...
    public static String toStrDateFromUtilDateByFormat(
            java.util.Date pUtilDate, String pFormat) throws ParseException {
        String result = "";
        if (pUtilDate != null) {
    ...
    public static int getWeekOfDate(String date) {
        ParsePosition pos = new ParsePosition(0);
        java.util.Date parseDate = new SimpleDateFormat(NORMAL_FORMAT).parse(date,
                pos);
     ...
     * @param format
     * @return
     * @see DateUtils#formatDateStr(String, String)
     */
    @Deprecated
    ...
    public static long dateDiffToMinuteD(String startTime, String toTime) {
        ...
        if (StringUtils.checkEmpty(startTime) != null && StringUtils.checkEmpty(toTime) != null) {
            ...
            ParsePosition pos = new ParsePosition(0);
            java.util.Date startTimeD = format.parse(startTime, pos);
            pos.setIndex(0);
            java.util.Date toTimeD = format.parse(toTime, pos);
