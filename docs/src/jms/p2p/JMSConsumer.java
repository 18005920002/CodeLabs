...
public class JMSConsumer {
    ...
    public static void main(String[] args) {
        ...
        connectionFactory = new ActiveMQConnectionFactory(JMSConsumer.USERNAME, JMSConsumer.PASSWORD, JMSConsumer.BORKEURL);
        try {
            ...
            consumer.setMessageListener(new MessageListener() {
                ...
                public void onMessage(Message arg0) {
                    try {
                        System.out.println("Consumer Receive：" + ((TextMessage) arg0).getText());
